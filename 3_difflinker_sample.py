...
# for n_atoms in range(5,11):
    ...
    for node in nodes:
        if node != 'V':
            ...
            run_dflk_sample_analyze(input_path="data/fragments_all/{node}/hMOF_frag_frag.sdf", model="models/geom_difflinker.ckpt", linker_size=n_atoms, output_dir=OUTPUT_DIR, n_samples=1)
