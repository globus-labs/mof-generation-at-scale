...
from src.difflinker_egnn import Dynamics, DynamicsWithPockets
# from src.edm import EDM, InpaintingEDM
from src.difflinker_edm import EDM, InpaintingEDM
from src.difflinker_datasets import (
...
class DDPM(pl.LightningModule):
    ...
    def forward(self, data, training):
        ...
        property_context = data['property_context'] #(batch, dim) https://github.com/ehoogeboom/e3_diffusion_for_molecules/blob/fce07d701a2d2340f3522df588832c2c0f7e044a/qm9/sampling.py#L110:~:text=context%20%3D%20context.unsqueeze(1).repeat(1%2C%20max_n_nodes%2C%201).to(device)%20*%20node_mask
        ...
        ###ADD ZERO CONV and REWARD CONDITION HERE!!!
        return self.edm.forward(
            ...
            edge_mask=edge_mask,
            context=context,
            property_context=property_context #https://github.com/ehoogeboom/e3_diffusion_for_molecules/blob/fce07d701a2d2340f3522df588832c2c0f7e044a/qm9/sampling.py#L110:~:text=context%20%3D%20context.unsqueeze(1).repeat(1%2C%20max_n_nodes%2C%201).to(device)%20*%20node_mask
        )
    ...
    def training_step(self, data, *args):
        try:
            ...
            self.unfortunate_skips += 1
            return None #https://lightning.ai/docs/pytorch/stable/common/lightning_module.html#:~:text=defined%20or%20not.-,training_step,This%20is%20not%20supported%20for%20multi%2DGPU%2C%20TPU%2C%20IPU%2C%20or%20DeepSpeed.,-In%20this%20step
    ...
    def training_epoch_end(self, training_step_outputs):
        ...
        self.log('unfortunate_skips_perct/train', self.unfortunate_skips/len(self.train_dataloader()), prog_bar=True)
    ...
    def validation_epoch_end(self, validation_step_outputs):
        ...
        self.log('unfortunate_skips_perct/val', self.unfortunate_skips/len(self.val_dataloader()), prog_bar=True)
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        self.log('unfortunate_skips_perct/test', self.unfortunate_skips/len(self.test_dataloader()) , prog_bar=True)
    ...
    def sample_chain(self, data, sample_fn=None, keep_frames=None):
        ...
        property_context = template_data['property_context']
    ...
    def configure_optimizers(self):
        #FINETUNING: NEW thing!
        return torch.optim.AdamW(self.edm.dynamics.dynamics_control.parameters(), lr=self.lr) #, amsgrad=True, weight_decay=1e-12)
