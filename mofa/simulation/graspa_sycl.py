...
class GRASPASyclRunner:
    ...
    def run_gcmc(
        ...
        """Execute gRASPA-sycl with specified input parameters.
        ...
        Returns:
            tuple[float, float, float, float]: Computed uptake (U) and error (E) from gRASPA-sycl in the following order:
                - U (mol/kg)
                - E (mol/kg)
                - U (g/L)
                - E (g/L)
